...
class ReactFormType extends AbstractType
{
    ...
    private function buildTemplateView(FormView $view): array
    {
        ...
        $vars['special_data'] = key_exists('special_data', $view->vars) ? $view->vars['special_data'] : [];
        ...
        if ($vars['type'] === 'auto_suggest') {
            ...
            $vars['suggestionsClass'] = 'xs:block absolute xs:static top-0 right-0 w-full hidden';
        }
