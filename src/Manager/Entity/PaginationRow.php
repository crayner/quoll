...
class PaginationRow
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'actionTitle' => TranslationHelper::translate('Actions'),
            'emptyContent' => TranslationHelper::translate('There are no records to display.'),
            'caption' => TranslationHelper::translate('Records {start}-{end} of {total}'),
            'firstPage' => TranslationHelper::translate('First Page'),
            'prevPage' => TranslationHelper::translate('Previous Page'),
            'nextPage' => TranslationHelper::translate('Next Page'),
            'lastPage' => TranslationHelper::translate('Last Page'),
